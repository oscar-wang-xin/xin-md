...
/* ---------------- 公众号排版 skill 移植主题（gzh-design-skill __skillhub） ---------------- */

/** 摸鱼绿：green 杂志卡片风，主色 emerald #059669，黄色渐变高亮（移植自 gzh-design-skill 摸鱼绿） */
export const moyuGreenTheme: Theme = {
  id: 'moyu-green',
  name: '摸鱼绿',
  description: '绿色杂志卡片风，信息密度高，教程 / 盘点 / 清单',
  appearance: 'light',
  mono: MONO,
  body: { font: SANS, fontSize: '14px', lineHeight: '1.9', color: '#374151', bg: '#ffffff' },
  accent: '#059669',
  accentSoft: 'rgba(5,150,105,.10)',
  heading: {
    font: SANS,
    fontWeight: '900',
    color: '#111827',
  ...
  headingSizes: { h1: '24px', h2: '20px', h3: '18px', h4: '17px', h5: '16px', h6: '15px' },
  pMargin: '16px',
  quote: {
    background: '#f9fafb',
    color: '#374151',
    ...
    padding: '12px 16px',
    margin: '20px 0',
    extra: { border: '1px dashed #d1d5db' },
  },
  callout: {
    background: '#f0fdf4',
    color: '#374151',
  ...
  code: { background: '#f3f4f6', color: '#1f2937', borderRadius: '4px', padding: '2px 6px', fontSize: '0.9em' },
  codeBlock: { background: '#1f2937', color: '#e5e7eb', borderRadius: '8px', padding: '14px 16px', fontSize: '13.5px', lineHeight: '1.65' },
  link: { color: '#059669', textDecoration: 'underline' },
  listPaddingLeft: '26px',
  listItemMargin: '6px 0',
  table: { borderColor: '#e5e7eb', headBg: '#f0fdf4', headColor: '#065f46', fontSize: '15px', cellPadding: '8px 12px' },
  hr: { color: '#d1d5db', margin: '28px 0' },
  img: { borderRadius: '12px', margin: '18px auto' },
  strongColor: '#059669',
  delColor: '#9ca3af',
  mark: { background: '#fde68a', color: '#111827', borderRadius: '3px', padding: '1px 4px' },
  footnote: { refColor: '#059669', blockBorder: '#e5e7eb', textColor: '#9ca3af', numColor: '#047857', textSize: '12px' },
  codePalette: PALETTE_LIGHT,
  codePaletteMode: 'light',
};

/** 红白色系：正红经典编辑风，淡粉下划线标记 + 编号章节（移植自 gzh-design-skill 红白色系） */
export const redWhiteTheme: Theme = {
  id: 'red-white',
  name: '红白色系',
  description: '正红经典编辑风，红色克制点睛',
  appearance: 'light',
  mono: MONO,
  body: { font: SANS, fontSize: '15px', lineHeight: '1.8', color: '#374151', bg: '#ffffff' },
  accent: '#dc2626',
  ...
  code: { background: '#fef2f2', color: '#dc2626', borderRadius: '3px', padding: '1px 5px', fontSize: '0.85em' },
  codeBlock: { background: '#1c1917', color: '#e7e5e4', borderRadius: '4px', padding: '15px 17px', fontSize: '13.5px', lineHeight: '1.65' },
  link: { color: '#dc2626', textDecoration: 'underline' },
  listPaddingLeft: '26px',
  listItemMargin: '7px 0',
  table: { borderColor: '#e5e7eb', headBg: '#fef2f2', headColor: '#991b1b', fontSize: '15px', cellPadding: '8px 12px' },
  hr: { color: '#e5e7eb', margin: '30px 0' },
  img: { borderRadius: '4px', margin: '18px auto' },
  strongColor: '#dc2626',
  delColor: '#9ca3af',
  mark: { background: '#fecaca', color: '#1c1917', borderRadius: '2px', padding: '1px 4px' },
  footnote: { refColor: '#dc2626', blockBorder: '#e5e7eb', textColor: '#9ca3af', numColor: '#dc2626', textSize: '12px' },
  codePalette: PALETTE_LIGHT,
  codePaletteMode: 'light',
};

/** 石墨极简：石墨灰 #52525B + 纯白 + 1px 细线 + 超大留白（移植自 gzh-design-skill 石墨极简风） */
export const graphiteMinimalTheme: Theme = {
  id: 'graphite-minimal',
  name: '石墨极简',
  description: '石墨灰 + 细线 + 超大留白，极简克制',
  appearance: 'light',
  mono: MONO,
  body: { font: SANS, fontSize: '15px', lineHeight: '1.8', color: '#52525b', bg: '#ffffff' },
  accent: '#52525b',
  accentSoft: 'rgba(82,82,91,.08)',
  heading: {
    font: SANS,
    fontWeight: '700',
    color: '#27272a',
  ...
  code: { background: '#f4f4f5', color: '#3f3f46', borderRadius: '3px', padding: '2px 5px', fontSize: '0.9em' },
  codeBlock: { background: '#fafafa', color: '#3f3f46', borderRadius: '4px', padding: '14px 16px', fontSize: '13.5px', lineHeight: '1.65', extra: { border: '1px solid #e4e4e7' } },
  link: { color: '#52525b', textDecoration: 'underline' },
  listPaddingLeft: '25px',
  listItemMargin: '8px 0',
  table: { borderColor: '#e4e4e7', headBg: '#fafafa', headColor: '#27272a', fontSize: '15px', cellPadding: '8px 12px' },
  hr: { color: '#e4e4e7', margin: '32px 0' },
  img: { borderRadius: '0', margin: '20px auto' },
  strongColor: '#27272a',
  delColor: '#a1a1aa',
  mark: { background: '#e4e4e7', color: '#27272a', borderRadius: '2px', padding: '1px 4px' },
  footnote: { refColor: '#52525b', blockBorder: '#e4e4e7', textColor: '#a1a1aa', numColor: '#52525b', textSize: '12px' },
  codePalette: PALETTE_LIGHT,
  codePaletteMode: 'light',
};

/** 留白禅意：墨绿点缀 + 衬线大字 + 极简留白，东方禅意（移植自 gzh-design-skill 留白禅意风） */
export const zenWhitespaceTheme: Theme = {
  id: 'zen-whitespace',
  name: '留白禅意',
  description: '超大留白 + 衬线大字金句，东方禅意',
  appearance: 'light',
  mono: MONO,
  body: { font: SANS, fontSize: '15px', lineHeight: '1.9', color: '#525252', bg: '#ffffff' },
  accent: '#4a5d52',
  accentSoft: 'rgba(74,93,82,.08)',
  heading: {
    font: "'Noto Serif SC', Georgia, 'Songti SC', 'SimSun', serif",
    fontWeight: '600',
    color: '#2b2b2b',
    lineHeight: '1.5',
    letterSpacing: '0.8px',
  ...
  callout: {
    background: '#eef3f0',
    color: '#3d5046',
    borderLeft: '2px solid #b5c8bc',
    borderRadius: '8px',
    padding: '14px 18px',
    margin: '30px 0',
    badgeColor: '#3d5046',
  },
  code: { background: '#eef3f0', color: '#3d5046', borderRadius: '3px', padding: '2px 5px', fontSize: '0.9em' },
  codeBlock: { background: '#f4f7f5', color: '#3a463e', borderRadius: '6px', padding: '14px 16px', fontSize: '13.5px', lineHeight: '1.7' },
  link: { color: '#4a5d52', textDecoration: 'underline' },
  listPaddingLeft: '24px',
  listItemMargin: '10px 0',
  table: { borderColor: '#e8e8e8', headBg: '#fafafa', headColor: '#2b2b2b', fontSize: '14.5px', cellPadding: '10px 14px' },
  hr: { color: '#e8e8e8', margin: '40px 0' },
  img: { borderRadius: '2px', margin: '28px auto' },
  strongColor: '#2b2b2b',
  delColor: '#a3a3a3',
  mark: { background: '#d6e4dc', color: '#2b2b2b', borderRadius: '2px', padding: '1px 3px' },
  footnote: { refColor: '#4a5d52', blockBorder: '#e8e8e8', textColor: '#a3a3a3', numColor: '#4a5d52', textSize: '12px' },
  codePalette: PALETTE_LIGHT,
  codePaletteMode: 'light',
};

/** 摸鱼票据：票据 / 门票风，米黄纸底 + 黑色硬边 + 撕票虚线（移植自 gzh-design-skill 摸鱼票据风） */
export const moyuTicketTheme: Theme = {
  id: 'moyu-ticket',
  name: '摸鱼票据',
  description: '票据 / 门票造型，硬阴影 + 撕票虚线',
  appearance: 'light',
  mono: MONO,
  body: { font: SANS, fontSize: '14px', lineHeight: '1.9', color: '#555555', bg: '#fffef8' },
  accent: '#059669',
  accentSoft: 'rgba(5,150,105,.10)',
  heading: {
    font: SANS,
  ...
  quote: {
    ...
    padding: '13px 17px',
    margin: '22px 0',
    extra: { 'box-shadow': '4px 4px 0 rgba(5,150,105,.15)' },
  },
  callout: {
    background: '#f0fdf4',
    color: '#374151',
  ...
  code: { background: '#f3f4f6', color: '#1f2937', borderRadius: '4px', padding: '2px 6px', fontSize: '0.9em' },
  codeBlock: { background: '#f7f7f5', color: '#1f2937', borderRadius: '6px', padding: '15px 17px', fontSize: '13.5px', lineHeight: '1.65', extra: { border: '3px solid #1a1a1a', 'box-shadow': '4px 4px 0 rgba(26,26,26,.15)' } },
  link: { color: '#059669', textDecoration: 'underline' },
  listPaddingLeft: '26px',
  listItemMargin: '6px 0',
  table: { borderColor: '#1a1a1a', headBg: '#059669', headColor: '#ffffff', fontSize: '14px', cellPadding: '8px 12px' },
  hr: { color: '#a7f3d0', margin: '26px 0' },
  img: { borderRadius: '2px', margin: '20px auto' },
  strongColor: '#059669',
  delColor: '#999999',
  mark: { background: '#a7f3d0', color: '#1a1a1a', borderRadius: '2px', padding: '1px 4px' },
  footnote: { refColor: '#059669', blockBorder: '#d1d5db', textColor: '#888888', numColor: '#059669', textSize: '12px' },
  codePalette: PALETTE_LIGHT,
  codePaletteMode: 'light',
};

/** 橄榄手记：内刊编辑部质感，墨黑 #1e1f23 + 橙色 #ed7b2f 点睛（移植自 gzh-design-skill 橄榄手记） */
export const oliveJournalTheme: Theme = {
  id: 'olive-journal',
  name: '橄榄手记',
  description: '内刊手记，墨黑 + 橙色点睛',
  appearance: 'light',
  mono: MONO,
  body: {
    font: "'IBM Plex Sans',-apple-system,BlinkMacSystemFont,'PingFang SC','Hiragino Sans GB','Microsoft YaHei',sans-serif",
    fontSize: '14px',
    lineHeight: '1.9',
    color: '#4d4f46',
    bg: '#fdfdf8',
  ...
  callout: {
    background: '#eeefe9',
    color: '#4d4f46',
    borderLeft: '3px solid #ed7b2f',
    borderRadius: '6px',
    padding: '13px 16px',
    margin: '24px 0',
    badgeColor: '#b1580f',
  },
  code: { background: '#e5e7e0', color: '#23251d', borderRadius: '3px', padding: '2px 5px', fontSize: '0.88em' },
  codeBlock: { background: '#1e1f23', color: '#e5e7e0', borderRadius: '6px', padding: '14px 16px', fontSize: '13px', lineHeight: '1.65' },
  link: { color: '#ed7b2f', textDecoration: 'underline' },
  listPaddingLeft: '25px',
  listItemMargin: '7px 0',
  table: { borderColor: '#bfc1b7', headBg: '#1e1f23', headColor: '#fdfdf8', fontSize: '14px', cellPadding: '8px 12px' },
  hr: { color: '#bfc1b7', margin: '30px 0' },
  img: { borderRadius: '6px', margin: '18px auto' },
  strongColor: '#1e1f23',
  delColor: '#9ea096',
  mark: { background: '#f5dcc7', color: '#23251d', borderRadius: '2px', padding: '1px 4px' },
